...
/** Tree-shaken icon set — keep in sync with FA_TO_LUCIDE + template data-lucide usage */
const icons = {
    AlignJustify,
    AlignLeft,
    Archive,
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Defer MutationObserver — avoids main-thread cost during first paint / Lighthouse
    const startObserver = () => observeDynamicIcons();

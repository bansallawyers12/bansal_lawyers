	...
	<li class="dropdown dropdown-list-toggle">
		...
		<li class="dropdown">
			<a href="#" data-toggle="dropdown"class="nav-link dropdown-toggle nav-link-lg nav-link-user">
				...
				@else
				<img  alt="{{\Illuminate\Support\Str::limit(Auth::user()->first_name.' '.Auth::user()->last_name, 150, '...')}}" src="{{URL::to('/public/img/profile_imgs')}}/{{@Auth::user()->profile_img}}" class="user-img-radious-style"/>
				@endif	
				<span class="d-sm-none d-lg-inline-block"></span>
			</a>
            <div class="dropdown-menu dropdown-menu-right pullDown">
				<div class="dropdown-title">{{\Illuminate\Support\Str::limit(Auth::user()->first_name.' '.Auth::user()->last_name, 150, '...')}}</div>

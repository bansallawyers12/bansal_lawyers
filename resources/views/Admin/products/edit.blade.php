...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="admin/products/edit" autocomplete="off" method="post">
			<input type="hidden" name="id" value="@$fetchedData->id"> 
				...
				@endforeach
											...
											<div class="row">
												<div class="col-12 col-md-6 col-lg-6">
													<div class="form-group"> 
														...
														<input name="duration" type="text" value="@$fetchedData->duration" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Duration">
								...
								<div class="form-group float-right">
									<button type="button" class="btn btn-primary" onClick="customValidate("edit-products")">Update Product</button>	
								</div>
							</div>
						</div>
					</div>	

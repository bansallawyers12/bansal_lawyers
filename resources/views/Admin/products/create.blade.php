...
<div class="main-content">
	<section class="section"> 
		<div class="section-body">
			<form action="admin/products/store" autocomplete="off" method="post">
				<div class="row">
		...
		<div class="row">
			<div class="col-12 col-md-6 col-lg-6">
				<div class="form-group"> 
					...
					<input name="duration" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Duration">
				...
				<div class="form-group"> 
					...
					@endif
								...
								<div class="form-group float-right">
									<button type="button" class="btn btn-primary" onClick="customValidate("add-products")">Save Product</button>
								</div>
							</div>
						</div>
					</div>

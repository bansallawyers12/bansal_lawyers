			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  <form action="admin/offer/edit" autocomplete="off" method="post">
						...
						<div class="card-body">
							<div class="form-group" style="text-align:right;">
								...
								<button type="button" class="btn btn-primary" onClick="customValidate("add-flights")"><i class="fa fa-save"></i> Edit Offer</button>
							</div>
							...
							<div class="form-group row"> 
								...
								<input name="subtitle" type="text" value="@$fetchedData->subtitle" class="form-control " data-valid="" autocomplete="off" placeholder="Enter Subtitle" id="">
							...
							<div class="form-group row"> 
								...
								<div class="col-sm-10">
								<input name="expire_date" type="text" value="@$fetchedData->expiry_date" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Expire Date" id="ardate">

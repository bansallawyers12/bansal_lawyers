...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="admin/branch/edit" autocomplete="off" method="post">
						...
						<div class="card">
							<div class="card-body">
											...
											<div class="row"> 						
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<input name="office_name" type="text" value="@$fetchedData->office_name" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Office Name">
											...
											<div class="row">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<input name="mobile" type="text" value="@$fetchedData->mobile" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Mobile">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<input name="contact_person" type="text" value="@$fetchedData->contact_person" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Contact Person">
								...
								<div class="form-group float-right">
									<button type="button" class="btn btn-primary" onClick="customValidate("edit-branch")">Update Branch</button> 
								</div>
							</div>
						</div>
					</div>

...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="admin/partners/edit" autocomplete="off" method="post">
						...
						<div class="card">
							<div class="card-body">
													...
													<div class="row">
														...
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<input name="partner_name" type="text" value="@$fetchedData->partner_name" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Partner Name">
														...
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<input name="business_reg_no" type="text" value="@$fetchedData->business_reg_no" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Business Registration Number">
											...
											<div class="row">
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<input name="address" type="text" value="@$fetchedData->address" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Address">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<input name="city" type="text" value="@$fetchedData->city" class="form-control" data-valid="" autocomplete="off" placeholder="Enter City">
														@if ($errors->has('city'))
															<span class="custom-error" role="alert">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<input name="state" type="text" value="@$fetchedData->state" class="form-control" data-valid="" autocomplete="off" placeholder="Enter State">
														@if ($errors->has('state'))
															<span class="custom-error" role="alert">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<input name="zip" type="text" value="@$fetchedData->zip" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Zip / Post Code">
														@if ($errors->has('zip'))
															<span class="custom-error" role="alert">
											...
											<div class="row">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<input name="email" type="text" value="@$fetchedData->email" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Email">
														@if ($errors->has('email'))
															<span class="custom-error" role="alert">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<input name="fax" type="text" value="@$fetchedData->fax" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Fax">
														@if ($errors->has('fax'))
															<span class="custom-error" role="alert">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<input name="website" type="text" value="@$fetchedData->website" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Website">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<input name="level" type="text" value="@$fetchedData->level" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Level">
														@if ($errors->has('level'))
															<span class="custom-error" role="alert">
								...
								<div class="form-group float-right">
									...
									<button type="button" class="btn btn-primary" onClick="customValidate("edit-partner")">Update Partner</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<input name="branch_name" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Name">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<input name="branch_email" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Email">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<input name="branch_city" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter City">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<input name="branch_state" type="text" class="form-control" data-valid="" autocomplete="off" placeholder="Enter State">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<input name="branch_address" type="text" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Street">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<input name="branch_zip" type="text" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Zip / Post Code">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<div class="cus_field_input">
									...
									<input name="branch_phone" type="text" class="form-control tel_input" data-valid="" autocomplete="off" placeholder="Enter Phone">

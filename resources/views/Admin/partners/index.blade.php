									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<input name="reginal_code" type="text" value="Request::get('reginal_code')" class="form-control" data-valid="" autocomplete="off" placeholder="Reginal code" id="reginal_code">
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												<label for="level" class="col-form-label">Level</label>
												<input name="level" type="text" value="Request::get('level')" class="form-control" data-valid="" autocomplete="off" placeholder="Level" id="level">
											</div>
										</div>		

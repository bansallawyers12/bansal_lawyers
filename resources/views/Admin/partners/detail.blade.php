										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input name="contract_expiry" type="text" value="@$fetchedData->contract_expiry" class="form-control contract_expiry" data-valid="" autocomplete="off" placeholder="Select Date">
											...
											<div class="col-12 col-md-12 col-lg-12">
                                                ...
                                                if( isset($fetchedData->file_upload ) && $fetchedData->file_upload != ""){
                                                    $file_url = "https://bansalimmigration.com.au/public/img/documents/".$fetchedData->file_upload;
                                                ?>

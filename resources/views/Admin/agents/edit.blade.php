...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="admin/agents/edit" autocomplete="off" method="post">
											...
											<div class="row">
												<div class="col-12 col-md-6 col-lg-6 is_individual">
													<div class="form-group"> 
														...
														<input name="full_name" type="text" value="@$fetchedData->full_name" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Full Name">
												...
												<div class="col-12 col-md-6 col-lg-6 is_business" >
													<div class="form-group"> 
														...
														<input name="business_name" type="text" value="@$fetchedData->business_name" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Business Name">
												...
												<div class="col-12 col-md-6 col-lg-6 is_business <?php if($fetchedData->struture == 'Individual'){ echo ''; } ?>">
													<div class="form-group"> 
														...
														<input name="c_name" type="text" value="@$fetchedData->full_name" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Primary Contact Name">
												...
												<div class="col-12 col-md-6 col-lg-6 is_business <?php if($fetchedData->struture == 'Individual'){ echo ''; } ?>">
													<div class="form-group"> 
														...
														<input name="tax_number" type="text" value="@$fetchedData->tax_number" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Tax Number">
												...
												<div class="col-12 col-md-6 col-lg-6 is_business <?php if($fetchedData->struture == 'Individual'){ echo ''; } ?>">
													<div class="form-group"> 
														...
														<div class="input-group">
															...
															<input name="contract_expiry_date" type="text" value="@$fetchedData->contract_expiry_date" class="form-control datepicker" data-valid="" autocomplete="off" placeholder="Select Date">
														</div>

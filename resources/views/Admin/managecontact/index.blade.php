					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input name="company_name" type="text" value="Request::get('company_name')" class="form-control" data-valid="" autocomplete="off" placeholder="Company Name" id="company_name">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="email" class="col-form-label">Email</label>
								<input name="email" type="text" value="Request::get('email')" class="form-control" data-valid="" autocomplete="off" placeholder="Email" id="name">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="first_name" class="col-form-label">First Name</label>
								<input name="first_name" type="text" value="Request::get('first_name')" class="form-control" data-valid="" autocomplete="off" placeholder="First Name" id="first_name">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="last_name" class="col-form-label">Last Name</label>
								<input name="last_name" type="text" value="Request::get('last_name')" class="form-control" data-valid="" autocomplete="off" placeholder="Last Name" id="last_name">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">

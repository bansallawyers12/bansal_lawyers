...
@section('title', 'Appointment Date Blocks')
						...
						<div class="modern-card">
							<div class="modern-card-header">
								...
								<div class="modern-header-actions">
									<a href="{{ route('admin.feature.appointmentdisabledate.create') }}" class="modern-btn modern-btn-primary">
											...
											<tr id="id_{{$list->id}}">
												...
												<td>
													<div class="modern-actions">
														<a class="modern-btn modern-btn-success modern-btn-sm" href="{{route('admin.feature.appointmentdisabledate.edit', base64_encode(convert_uuencode($list->id)))}}">

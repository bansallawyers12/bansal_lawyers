							...
							<div class="table-responsive common_table">
								...
								@foreach (@$lists as $list)
									<tr id="id_{{@$list->id}}">
										...
										<td>
                                            <?php
                                            $disableSlotArr = \App\Models\BookServiceDisableSlot::select('id','book_service_slot_per_person_id','disabledates','slots')->where('book_service_slot_per_person_id',$list->id)->get();

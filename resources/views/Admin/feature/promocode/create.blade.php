...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="admin/promo-code/store" autocomplete="off" method="post">
				<div class="row">
                                            ...
                                            <div class="row">
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<input name="code" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Code">
														@if ($errors->has('code'))
															<span class="custom-error" role="alert">

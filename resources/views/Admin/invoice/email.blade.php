			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  <form action="admin/invoice/email" autocomplete="off" method="post">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group" style="text-align:right;">
										...
										<button type="button" class="btn btn-primary" onClick="customValidate("email-invoice")"><i class="fa fa-mail"></i> Send</button>
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group"> 
										<label for="from" class="col-form-label">From <span style="color:#ff0000;">*</span></label>
										<input name="from" type="text" value="Auth::user()->email" class="form-control" data-valid="required" autocomplete="off" placeholder="">
										@if ($errors->has('from'))
								...
								<div class="col-sm-12">
									<div class="form-group"> 
										...
										<input name="send_to" type="text" value="@$invoice->customer->contact_email" class="form-control" data-valid="required" autocomplete="off" placeholder="">
					...
					$subContent	=	str_replace($replacesub,$replace_with_sub,$subContent);
									?>
										...
										<input name="subject" type="text" value="@$subContent" class="form-control" data-valid="required" autocomplete="off" placeholder="">
									...
									<div class="form-group"> 
										...
										<?php foreach(\App\Models\AttachFile::where('invoice_id', '=', $invoice->id)->get() as $alist){ ?>
											<li id="rem_{{@$alist->id}}">{{@$alist->name}}<a href="javascript:;" class="removeattacmet" id="{{@$alist->id}}"><i class="fa fa-times"></i></a>
											 <input type="hidden" name="attacfile_id[]" value="@$alist->id">
											</li>
										<?php } ?>
										</ul>
									</div>

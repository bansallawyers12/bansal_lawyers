...
<div class="main-content">
	...
	<section class="section">
		<div class="section-body">
			<form action="admin/invoice/general-edit" autocomplete="off" method="post">
						...
						<div class="card">							
							<div class="card-body">
								<div class="form-group"> 
									...
									<input name="invoice_date" type="text" value="$invoicedetail->invoice_date" class="form-control datepicker" data-valid="" autocomplete="off" placeholder="Select Date">
								...
								<div class="form-group"> 
									...
									<input name="invoice_due_date" type="text" value="$invoicedetail->due_date" class="form-control datepicker" data-valid="" autocomplete="off" placeholder="Select Date">
									<span class="span_note">Date must be in YYYY-MM-DD (2012-12-22) format.</span>

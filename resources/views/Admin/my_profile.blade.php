...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			...
			<form action="admin/my_profile" enctype="multipart/form-data" method="post">
					...
					<div class="card">
						<div class="card-body">
							<div class="row">
									...
									<div class="form-group"> 
										...
										<div class="profile_upload">
											...
											@if(@$fetchedData->profile_img != '')
												<img src="{{ @smartasset('img/profile_imgs')}}/{{@$fetchedData->profile_img}}" style="width:100px;height:100px;" id="output"/> 
											@else
												<img id="output" src="{{ @smartasset('images/no_image.jpg')}}"/> 
											@endif
								...
								<div class="form-group">
									<button type="button" class="btn btn-primary px-4" onClick="customValidate("my-profile")"><i class="fa fa-edit"></i> Update</button>
								</div>
							</div>
						</div>
					</div>

						...
						<div class="card-body table-responsive p-0">
							<table class="table table-hover text-nowrap">
							  ...
							  <tbody class="tdata">	
								...
								<tr id="id_{{@$list->id}}"> 
								  <td>{{ @$list->first_name == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(@$list->first_name, '50', '...') }}</td> 
								  <td>{{ @$list->last_name == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(@$list->last_name, '50', '...') }}</td> 

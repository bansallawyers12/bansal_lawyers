			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  <form action="admin/flight-detail/clone" autocomplete="off" method="post">
						...
						<div class="card-body">
							...
							<div class="form-group row"> 
								...
								<div class="col-sm-10">
								<input name="flight_number" type="text" value="@$fetchedData->flight_number" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Flight Number">
							...
							<div class="form-group row"> 
								...
								<input name="dep_time" type="text" value="@$fetchedData->dep_time" class="form-control " data-valid="" autocomplete="off" placeholder="Enter Departure Time" id="deptime">
							...
							<div class="form-group row"> 
								...
								<div class="col-sm-10">
								<input name="arival_time" type="text" value="@$fetchedData->arival_time" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Arrival Time" id="artime">
							...
							<div class="form-group row"> 
								...
								<div class="col-sm-10">
								<input name="duration" type="text" value="@$fetchedData->duration" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Duration">
							...
							<div @if(@$fetchedData->flighttype ==2)@else style="display:none;" @endif class="form-group row is_return"> 
								...
								<div class="col-sm-10">
								<input name="ret_flight_number" type="text" value="@$fetchedData->ret_flight_number" class="form-control" autocomplete="off" placeholder="Enter Flight Number">
							...
							<div @if(@$fetchedData->flighttype ==2)@else style="display:none;" @endif class="form-group row is_return"> 
								...
								<input name="ret_dep_time" type="text" value="@$fetchedData->ret_dep_time" class="form-control " autocomplete="off" placeholder="Enter Return Departure Time" id="retdeptime">
							...
							<div @if(@$fetchedData->flighttype ==2)@else style="display:none;" @endif class="form-group row is_return"> 
								...
								<div class="col-sm-10">
								<input name="ret_arv_time" type="text" value="@$fetchedData->ret_arv_time" class="form-control" autocomplete="off" placeholder="Enter Return Arrival Time" id="retartime">
							...
							<div @if(@$fetchedData->flighttype ==2)@else style="display:none;" @endif class="form-group row is_return"> 
								...
								<div class="col-sm-10">
								<input name="ret_duration" type="text" value="@$fetchedData->ret_duration" class="form-control" autocomplete="off" placeholder="Enter Return Duration">
							...
							<div class="form-group row"> 
								...
								<div class="col-sm-10">
								<input name="bc_total" type="text" value="@$fetchedData->bc_total" class="form-control" data-valid="" autocomplete="off" placeholder="Enter B2C Total Fare">
							...
							<div class="form-group row"> 
								...
								<div class="col-sm-10">
								<input name="bb_total" type="text" value="@$fetchedData->bb_total" class="form-control" data-valid="" autocomplete="off" placeholder="Enter B2B Total Fare">

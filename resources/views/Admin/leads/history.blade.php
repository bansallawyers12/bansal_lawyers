...
<div id="myAddnotes" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="admin/followup/store" autocomplete="off" method="post">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" onClick="customValidate("add-note")"><i class="fa fa-save"></i> Save</button>
			</div>
			 </form>
		</div>
	</div>
...
<div id="emailmodal"  data-backdrop="static" data-keyboard="false" class="modal fade custom_modal" tabindex="-1" role="dialog" aria-labelledby="clientModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="admin/followup/compose" autocomplete="off" method="post">
				<input id="" name="lead_id" type="hidden" value="{{base64_encode(convert_uuencode(@$fetchedData->id))}}">
					<div class="row">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<input name="email_to" type="text" value="@$fetchedData->email" class="form-control" data-valid="required" autocomplete="off" placeholder="" id="email_to">

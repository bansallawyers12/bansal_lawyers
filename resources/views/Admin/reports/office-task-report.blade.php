										...
										<table class="table text_wrap">
											...
											<tbody class="tdata">	
												...
												<tr id="id_{{@$list->id}}">
													...
													<td>{{ @$list->partner_name == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(@$list->partner_name, '50', '...') }}</td>
													<td>{{ @$list->description == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(@$list->description, '50', '...') }}</td>
													<td>{{ @$list->priority == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(@$list->priority, '50', '...') }}</td>
													<td>
														<?php
														if($list->status == 1){
													...
													<td>{{ @$list->due_time == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(@$list->due_time, '50', '...') }}</td>
													<td>{{ @$list->followers == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(@$list->followers, '50', '...') }}</td>
													<td>{{ @$list->related_to == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(@$list->related_to, '50', '...') }}</td>
													<td>-</td>
													<td>-</td>
													<td>-</td>
												</tr>

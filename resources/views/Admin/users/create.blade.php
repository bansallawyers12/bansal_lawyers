...
<div class="main-content">
	<section class="section">
		...
		<div class="server-error">
			...
			<form action="admin/users/store" autocomplete="off" method="post">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<input name="email" type="text" class="form-control" data-valid="required email" autocomplete="off" placeholder="Enter Email">
									@if ($errors->has('email'))
										<span class="custom-error" role="alert">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<input name="position" type="text" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Position Title">

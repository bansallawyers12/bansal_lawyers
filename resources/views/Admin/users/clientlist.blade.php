							...
							<table class="table">
								...
								<tbody class="tdata">	
									...
									<tr id="id_{{@$list->id}}"> 
										...
										<td>{{ @$list->first_name == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(@$list->first_name, '50', '...') }} {{ @$list->last_name == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(@$list->last_name, '50', '...') }}</td> 

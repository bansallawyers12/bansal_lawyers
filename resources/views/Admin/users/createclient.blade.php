...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="admin/users/storeclient" autocomplete="off" method="post">
				<div class="row">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group"> 
									...
									<input name="company_name" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Company Name">
								...
								<div class="form-group">
									...
									<input name="company_website" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Company Website">
						...
						<div class="card">
							<div class="card-body">
								<div class="form-group">
									...
									<input name="phone" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Phone Number">
									@if ($errors->has('phone'))
										<span class="custom-error" role="alert">
								...
								<div class="form-group">
									...
									<input name="city" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="City">
									@if ($errors->has('city'))
										<span class="custom-error" role="alert">
								...
								<div class="form-group">
									...
									<input name="gst_no" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="e.g. 22AAAAA00000AZ5">

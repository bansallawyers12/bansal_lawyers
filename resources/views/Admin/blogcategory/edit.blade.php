							...
							<form action="admin/blogcategories/edit" autocomplete="off" method="post" id="edit-category-form">
								...
								<div class="modern-form-body">
									<div class="modern-info-badge">
										...
										Editing Category ID: #{{$fetchedData->id}}
									</div>
									...
									<div class="modern-form-group">
										...
										<input name="name" type="text" class="modern-form-input" data-valid="required" autocomplete="off" placeholder="Enter category name" value="{{ old('name', $fetchedData->name) }}">
										@if ($errors->has('name'))
										...
										<select class="modern-select" name="parent_id">
											...
											@if($categories)
												@foreach($categories as $category)
													@if($category->id != $fetchedData->id)
														<option value="{{$category->id}}" {{ old('parent_id', $fetchedData->parent_id) == $category->id ? 'selected' : '' }}>
															{{$category->name}}
														</option>
													@endif
												@endforeach

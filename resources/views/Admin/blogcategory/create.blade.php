			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  <form action="admin/blogcategories/store" autocomplete="off" method="post">
					  ...
					  <div class="card-body">
							<div class="form-group" style="text-align:right;">
								...
								<button type="button" class="btn btn-primary" onClick="customValidate("add-blogcategory")"><i class="fa fa-save"></i> Save Blog Category</button>
							</div>

	...
	<div class="col-md-3">
		<div class="cus_sidebar">
			<div class="form-group">
				...
				<input name="applied_intake" type="text" value="$fetchData->intakedate" class="form-control datepicker" data-valid="" autocomplete="off" placeholder="Select Date">
			...
			<div class="form-group">
				...
				<input name="expect_win_date" type="text" value="$fetchData->expect_win_date" class="form-control expectdatepicker" data-valid="" autocomplete="off" placeholder="Select Date">
				<span class="span_note">Date must be in YYYY-MM-DD (2012-12-22) format.</span>

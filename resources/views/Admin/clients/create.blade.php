								...
								<div class="row">
										...
										<div class="row">
											...
											<div class="col-4 col-md-4 col-lg-4">
															<div class="form-group"> 
																...
																<input name="client_id" type="text" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<div class="cus_field_input">
												...
												<input name="phone" type="text" class="form-control tel_input" data-valid="required" autocomplete="off" placeholder="" id="checkphone">
												@if ($errors->has('phone'))
													<span class="custom-error" role="alert">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<input name="email" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="" id="checkemail">
											@if ($errors->has('email'))
												<span class="custom-error" role="alert">
								...
								<div class="row">
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<input name="address" type="text" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<input name="city" type="text" class="form-control" data-valid="" autocomplete="off" placeholder="">
											@if ($errors->has('city'))
												<span class="custom-error" role="alert">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<input name="zip" type="text" class="form-control" data-valid="" autocomplete="off" placeholder="">
											@if ($errors->has('zip'))
												<span class="custom-error" role="alert">
							...
							@endforeach
									...
									<div class="col-sm-12">
										<div class="form-group float-right">
											<button type="button" class="btn btn-primary" onClick="customValidate("add-clients")">Save</button>
										</div>
									</div>
								</div> 
							</div>

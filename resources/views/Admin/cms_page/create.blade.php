								...
								<div class="modern-form-body">
									...
									<div class="modern-form-grid">
										<div class="modern-form-group">
											...
											<input name="title" type="text" class="modern-form-input" data-valid="required" autocomplete="off" placeholder="Enter page title" value="{{ old('title') }}">
											@if ($errors->has('title'))
									...
									<div class="modern-form-grid">
										...
										<div class="modern-form-group">
											...
											<input name="meta_keyward" type="text" class="modern-form-input" autocomplete="off" placeholder="keyword1, keyword2, keyword3" value="{{ old('meta_keyward') }}">
									...
									<div class="modern-form-group">
										...
										<div class="modern-checkbox-container">
											<label class="modern-checkbox">
												<input value="1" type="checkbox" name="status" {{ old('status') ? 'checked' : '' }} data-bootstrap-switch>
...
// Custom validation function that handles CKEditor for CMS pages
function validateAndSubmitCMS() {

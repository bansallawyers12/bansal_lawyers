                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="upload_img">
                                    {{--@if($fetchedData->image != '')--}}
                                        <!--<img width="70" src="{{ asset('images/blog/' . $fetchedData->image) }}" class="<?php echo $fetchedData->title; ?>"/>-->
                                    {{--@endif--}}
                                    ...
                                    if(isset($fetchedData->image) && $fetchedData->image != ""){
                                        ...
                                        <?php
                                            ...
                                            ?>
                                            <a href="{{ asset('images/blog/' . $fetchedData->image) }}" target="_blank" data-toggle="tooltip" data-placement="top" title="Click Here To View"><img src="{{ asset('images/avatars/pdf_icon.png') }}" alt="" style="width:80px;height:80px;border-radius: 50%;"></a>
                                            <?php
                                        } else { ?>
                                            <img width="70" src="{{ asset('images/blog/' . $fetchedData->image) }}" class="{{ $fetchedData->title }}"/>
                                        <?php
                                        }
                                    } ?>
                                </div>
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="upload_img">
                                    @if($fetchedData->pdf_doc != '')
                                        <a target="_blank" href="{{ asset('images/blog/' . $fetchedData->pdf_doc) }}" >Click Here To Open PDF/Video</a>
                                    @endif
                                </div>
                            </div>
                        </div>

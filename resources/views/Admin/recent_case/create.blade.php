						...
						<div class="modern-form-card">
							...
							<form action="{{ route('admin.recent_case.store') }}" autocomplete="off" method="post" enctype="multipart/form-data" name="add-case" id="create-case-form">
								...
								<div class="modern-form-body">
									...
									<div class="modern-form-grid">
										<div class="modern-form-group">
											...
											<input name="title" type="text" class="modern-form-input" data-valid="required" autocomplete="off" placeholder="Enter case study title" value="{{ old('title') }}">
											@if ($errors->has('title'))
										...
										<div class="modern-form-group">
											...
											<input name="slug" type="text" class="modern-form-input" data-valid="required" autocomplete="off" placeholder="Enter URL slug" value="{{ old('slug') }}">
											@if ($errors->has('slug'))
												<span class="modern-error">
													{{ $errors->first('slug') }}
												</span>
										...
										<div class="modern-form-group">
											...
											<input name="image_alt" type="text" class="modern-form-input" autocomplete="off" placeholder="Describe the image for accessibility" value="{{ old('image_alt') }}">
									...
									<div class="modern-form-group full-width">
										...
										<input name="short_description" type="text" class="modern-form-input" autocomplete="off" placeholder="Enter a brief description or summary" value="{{ old('short_description') }}">
									...
									<div class="modern-form-group full-width">
										...
										<div class="modern-editor-container">
											<textarea class="modern-textarea" id="description" placeholder="Write your case study content here..." rows="10" name="description" data-valid="required">{{ old('description') }}</textarea>
										</div>
									...
									<div class="modern-form-grid">
										<div class="modern-form-group">
											...
											<input name="youtube_url" type="url" class="modern-form-input" autocomplete="off" placeholder="https://www.youtube.com/watch?v=..." value="{{ old('youtube_url') }}">
									...
									<div class="modern-form-grid">
										<div class="modern-form-group">
											...
											<input name="meta_title" type="text" class="modern-form-input" autocomplete="off" placeholder="SEO title for search engines" value="{{ old('meta_title') }}">
										...
										<div class="modern-form-group">
											...
											<input name="meta_keyword" type="text" class="modern-form-input" autocomplete="off" placeholder="keyword1, keyword2, keyword3" value="{{ old('meta_keyword') }}">
										...
										<div class="modern-form-group full-width">
											...
											<textarea name="meta_description" class="modern-textarea" placeholder="Brief description for search engines (150-160 characters)" rows="3">{{ old('meta_description') }}</textarea>
								...
								<div class="modern-form-footer">
									...
									<button type="button" class="modern-btn modern-btn-primary" data-custom-validate="add-case">

			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  <form action="admin/edit_email_template" autocomplete="off" method="post">
					   <input type="hidden" name="id" value="@$fetchedData->id">
						<div class="card-body">
							<div class="form-group" style="text-align:right;">
								...
								<button type="button" class="btn btn-primary" onClick="customValidate("edit-holidaytype")"><i class="fa fa-edit"></i> Update Template</button>
							</div>
						  ...
						  <div class="form-group row"> 
								...
								<div class="col-sm-10">
								<input name="subject" type="text" value="@$fetchedData->subject" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Subject">

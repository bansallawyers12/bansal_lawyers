								...
								<div class="modern-form-body">
									...
									<div class="modern-form-grid">
										<div class="modern-form-group">
											...
											<input name="title" type="text" class="modern-form-input" data-valid="required" autocomplete="off" placeholder="Enter blog post title" value="{{ old('title') }}">
											@if ($errors->has('title'))
									...
									<div class="modern-form-group full-width">
										...
										<input name="short_description" type="text" class="modern-form-input" autocomplete="off" placeholder="Enter a brief description or excerpt" value="{{ old('short_description') }}">
									...
									<div class="modern-form-group full-width">
										...
										<div class="modern-editor-container">
											<textarea class="modern-textarea" id="description" placeholder="Write your blog post content here..." rows="10" name="description" data-valid="required">{{ old('description') }}</textarea>
										</div>
									...
									<div class="modern-form-grid">
										<div class="modern-form-group">
											...
											@endif
											<div class="modern-help-text">
												Upload a featured image or video for your blog post
											</div>
										</div>

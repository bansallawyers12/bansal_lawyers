...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="admin/quotations/template/store" autocomplete="off" method="post">
				<div class="row">
								...
								<div class="row">
									<div class="col-12 col-md-4 col-lg-4">
										<div class="form-group"> 
											...
											<input name="template_name" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Template Name">

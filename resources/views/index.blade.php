...
<div class="hero-wrap js-fullheight" data-stellar-background-ratio="0.5">
    <img src="@smartasset('images/coart_1.jpg')" id="hero-image" alt="Top-rated lawyers in Australia – Expert legal services" class="hero-image"  loading="eager">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="carousel-case owl-carousel ftco-owl">
                       <!-- Case 1 -->
                        <div class="item">
                            <div class="case img d-flex align-items-center justify-content-center" style="background-image: url('@smartasset('images/Corporate_Legal_Separation_Corporate_Law.png')');">
                        ...
                        <!-- Case 2 -->
                        <div class="item">
                            <div class="case img d-flex align-items-center justify-content-center" style="background-image: url('@smartasset('images/Family_Law_Resolution.png')');">
                        ...
                        <!-- Case 3 -->
                        <div class="item">
                            <div class="case img d-flex align-items-center justify-content-center" style="background-image: url('@smartasset('images/Employment_Law_Dispute_Labor_Law.png')');">
                        ...
                        <!-- Case 4 -->
                        <div class="item">
                            <div class="case img d-flex align-items-center justify-content-center" style="background-image: url('@smartasset('images/Criminal_Defense_Victory_Criminal_Law.png')');">
                        ...
                        <!-- Case 5 -->
                        <div class="item">
                            <div class="case img d-flex align-items-center justify-content-center" style="background-image: url('@smartasset('images/Intellectual_Property_Protection_IP_Law.png')');">
                        ...
                        <!-- Case 6-->
                        <div class="item">
                            <div class="case img d-flex align-items-center justify-content-center" style="background-image: url('@smartasset('images/Real_Estate_Transaction_Real_Estate_Law.png')');">
    ...
    <section class="ftco-consultation ftco-section ftco-no-pt ftco-no-pb img">
        ...
        <div class="container">
            ...
            <div class="row d-md-flex justify-content-end">
              	 ...
              	 <div class="col-md-6">
                    <img src="@smartasset('images/bg_2.jpg')" alt="Ajay Bansal">
                 </div>
   ...
   onerror="this.style.backgroundImage='url(@smartasset('images/Blog.jpg'))'">

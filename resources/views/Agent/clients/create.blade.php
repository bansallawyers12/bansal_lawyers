...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="agent/clients/store" autocomplete="off" method="post">
				<div class="row">
						...
						<div class="card">
							<div class="card-body">
													...
													<div class="row">
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group"> 
																...
																<input name="first_name" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter First Name">
														...
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group"> 
																...
																<input name="last_name" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Last Name">
														...
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group"> 
																...
																<div class="input-group">
																	...
																	<input name="dob" type="text" class="form-control datepicker" data-valid="" autocomplete="off" placeholder="Select Date">
																	@if ($errors->has('dob'))
																		<span class="custom-error" role="alert">
											...
											<div class="row">
												<div class="col-12 col-md-6 col-lg-6">
													<div class="form-group"> 
														...
														<input name="att_email" type="text" class="form-control" data-valid="" autocomplete="off" placeholder="Enter att_email">
												...
												<div class="col-12 col-md-6 col-lg-6">
													<div class="form-group"> 
														...
														<div class="cus_field_input">
															...
															<input name="att_phone" type="text" class="form-control tel_input" data-valid="" autocomplete="off" placeholder="Enter Phone">
											...
											<div class="row">
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<div class="input-group">
															...
															<input name="preferredIntake" type="text" class="form-control datepicker" data-valid="" autocomplete="off" placeholder="Select Date">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<input name="passport_number" type="text" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Passport Number">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<div class="input-group">
															...
															<input name="visaExpiry" type="text" class="form-control datepicker" data-valid="" autocomplete="off" placeholder="Select Date">
								...
								<div class="form-group float-right">
									<button type="button" class="btn btn-primary" onClick="customValidate("add-clients")">Save Clients</button>
								</div>
							</div>
						</div>
					</div>

...
@section('seoinfo')
    ...
    <link rel="canonical" href="<?php echo URL::to('/'); ?>/commercial-law-experimental" />

    <!-- Facebook Meta Tags -->
    <meta property="og:url" content="<?php echo URL::to('/'); ?>/commercial-law-experimental">
    ...
    <meta property="twitter:url" content="<?php echo URL::to('/'); ?>/commercial-law-experimental">
	...
	<script type="application/ld+json">
	{
		...
		"url": "<?php echo URL::to('/'); ?>/commercial-law-experimental",
	...
	<script type="application/ld+json">
	{
		...
		"itemListElement": [
			...
			},
			{
				...
				"position": 3,
				"name": "Commercial Law",
				"item": "<?php echo URL::to('/'); ?>/commercial-law-experimental"
			}
		]
	}
	</script>

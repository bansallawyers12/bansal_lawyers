@props(['type' => 'sidebar', 'category' => 'general'])
...
@if($type === 'sidebar')
    ...
    <div class="blog-cta-sidebar">
        ...
        <form class="cta-form" action="/contact_lawyer" method="POST">
            @csrf
            <input type="hidden" name="source" value="blog-{{ $category }}">
            <input type="hidden" name="subject" value="Blog Inquiry - {{ $cta['title'] }}">
    ...
    <div class="blog-cta-inline">
        <div class="cta-content">
            ...
            <div class="cta-action">
                <a href="{{ $cta['button_link'] }}" class="cta-button-inline">
                    {{ $cta['button_text'] }}
                </a>
            </div>
        </div>
        ...
        <div class="cta-container">
            <div class="cta-main">
                ...
                <div class="cta-options">
                    <a href="{{ $cta['button_link'] }}" class="cta-button-primary">
                        <i class="{{ $cta['icon'] }}"></i>
                        {{ $cta['button_text'] }}
                    </a>

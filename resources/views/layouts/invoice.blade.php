...
<head>
	...
	<!--<title>@yield('title')</title>-->
	<!-- Favicons-->
    <link rel="shortcut icon" href="{!! @smartasset('img/Frontend/img/favicon.png') !!}" type="image/x-icon">
    <link rel="apple-touch-icon" type="image/x-icon" href="{!! @smartasset('img/Frontend/img/apple-touch-icon-57x57-precomposed.png') !!}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="{!! @smartasset('img/Frontend/img/apple-touch-icon-72x72-precomposed.png') !!}">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="{!! @smartasset('img/Frontend/img/apple-touch-icon-114x114-precomposed.png') !!}">

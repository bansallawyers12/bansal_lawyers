...
@section('content')
	...
	<!--Content-->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('public/images/PracticeArea.jpg');margin-bottom: 40px;max-height:422px !important;" data-stellar-background-ratio="0.5">
                                ...
                                <div class="card clearfix">
                                    <div class="card-header">
                                        <div class="field field--name-field-icon field--type-entity-reference field--label-hidden field__item">
                                            <img loading="lazy" src="/public/images/family-law.png" alt="Compassionate Legal Support for Family Law Cases" class="image-style-icon-92-x-92">
                                        </div>
                                    </div>
                        ...
                        <div class="field__item-card col-lg-3">
                            <div class="paragraph paragraph--type--migration-law-card paragraph--view-mode--default">
                                <div class="card clearfix">
                                    <div class="card-header">
                                        <div class="field field--name-field-icon field--type-entity-reference field--label-hidden field__item">
                                            <img loading="lazy" src="/public/images/immigration-law.png" alt="Expert Immigration Lawyers Helping You Settle in Australia" class="image-style-icon-92-x-92">
                                        </div>
                                    </div>
                        ...
                        <div class="field__item-card col-lg-3">
                            <div class="paragraph paragraph--type--general-federal-law-card paragraph--view-mode--default">
                                <div class="card clearfix">
                                    <div class="card-header">
                                        <div class="field field--name-field-icon field--type-entity-reference field--label-hidden field__item">
                                            <img loading="lazy" src="/public/images/criminal-law.png" alt="icon for overview" class="image-style-icon-92-x-92">
                                        </div>
                                    </div>
                        ...
                        <div class="field__item-card col-lg-3">
                            <div class="paragraph paragraph--type--family-law-card paragraph--view-mode--default">
                                <div class="card clearfix">
                                    <div class="card-header">
                                        <div class="field field--name-field-icon field--type-entity-reference field--label-hidden field__item">
                                            <img loading="lazy" src="/public/images/commercial-law.png" alt="icon for overview" class="image-style-icon-92-x-92">
                                        </div>
                                    </div>
                                ...
                                <div class="card clearfix">
                                    <div class="card-header">
                                        <div
                                            ...
                                            <img loading="lazy" src="/public/images/property-law.png"

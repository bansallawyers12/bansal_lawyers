...
@section('content')
	...
	<!--Content-->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('@smartasset('images/PracticeArea.jpg')');margin-bottom: 40px;max-height:422px !important;" data-stellar-background-ratio="0.5">
                                ...
                                <div class="card clearfix">
                                    <div class="card-header">
                                        <div class="field field--name-field-icon field--type-entity-reference field--label-hidden field__item">
                                            <img loading="lazy" src="@smartasset('images/family-law.png')" alt="Compassionate Legal Support for Family Law Cases" class="image-style-icon-92-x-92">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="field field--name-field-link-to-content-page field--type-link field--label-hidden field__item">
                                            <a href="/family-law" class="btn btn-primary">Read This More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="field__item-card col-lg-3">
                            <div class="paragraph paragraph--type--migration-law-card paragraph--view-mode--default">
                                <div class="card clearfix">
                                    <div class="card-header">
                                        <div class="field field--name-field-icon field--type-entity-reference field--label-hidden field__item">
                                            <img loading="lazy" src="@smartasset('images/immigration-law.png')" alt="Expert Immigration Lawyers Helping You Settle in Australia" class="image-style-icon-92-x-92">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="field field--name-field-link-to-content-page field--type-link field--label-hidden field__item">
                                            <a href="/migration-law" class="btn btn-primary">Read This More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="field__item-card col-lg-3">
                            <div class="paragraph paragraph--type--general-federal-law-card paragraph--view-mode--default">
                                <div class="card clearfix">
                                    <div class="card-header">
                                        <div class="field field--name-field-icon field--type-entity-reference field--label-hidden field__item">
                                            <img loading="lazy" src="@smartasset('images/criminal-law.png')" alt="icon for overview" class="image-style-icon-92-x-92">
                                        </div>
                                    </div>

                                    <div class="card-block card-body">
                                        <div class="field field--name-field-title field--type-string-long field--label-hidden field__item">Criminal Law</div>
                                    ...
                                    <div class="card-footer">
                                        <div class="field field--name-field-link-to-content-page field--type-link field--label-hidden field__item">
                                            <a href="/criminal-law" class="btn btn-primary">Read This More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="field__item-card col-lg-3">
                            <div class="paragraph paragraph--type--family-law-card paragraph--view-mode--default">
                                <div class="card clearfix">
                                    <div class="card-header">
                                        <div class="field field--name-field-icon field--type-entity-reference field--label-hidden field__item">
                                            <img loading="lazy" src="@smartasset('images/commercial-law.png')" alt="icon for overview" class="image-style-icon-92-x-92">
                                        </div>
                                    </div>

                                    <div class="card-block card-body">
                                        <div class="field field--name-field-title field--type-string-long field--label-hidden field__item">Commercial Law</div>
                                        <div class="field field--name-field-block-summary field--type-string-long field--label-hidden field__item">From Buying and Leasing to Dispute Resolution – Trusted Legal Guidance for All Your Property Matters</div>
                                    </div>

                                    <div class="card-footer">
                                        <div class="field field--name-field-link-to-content-page field--type-link field--label-hidden field__item">
                                            <a href="/commercial-law" class="btn btn-primary">Read This More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card clearfix">
                                    <div class="card-header">
                                        <div
                                            ...
                                            <img loading="lazy" src="@smartasset('images/property-law.png')"
                                    ...
                                    <div class="card-block card-body">
                                        <div
                                            class="field field--name-field-title field--type-string-long field--label-hidden field__item">
                                            Property Law</div>
                                        <div
                                            class="field field--name-field-block-summary field--type-string-long field--label-hidden field__item">
                                            Smart Legal Solutions for Smart Businesses – Simplifying Contracts, Mergers, Disputes, and Compliance</div>
                                    </div>

                                    <div class="card-footer">
                                        <div
                                            class="field field--name-field-link-to-content-page field--type-link field--label-hidden field__item">
                                            <a href="/property-law" class="btn btn-primary">Read This More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

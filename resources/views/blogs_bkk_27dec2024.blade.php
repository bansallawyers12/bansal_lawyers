			...
			<!-- Single Course Area -->
				...
				<div class="col-12 col-sm-6 col-lg-4">
					<div class="single-feature-area style-2 mb-4">
						{{--@if($list->image)--}}
						<!--<a href="<?php echo URL::to('/'); ?>/blogs/{{@$list->slug}}"><img src="https://bansalimmigration.com.au/public/img/blog/{{@$list->image}}"></img></a>-->
						{{--@endif--}}
                        ...
                        if(isset($list->image) && $list->image != ""){
                            ...
                            if( strtolower($extension) == 'mp4' ){
                               $src = 'https://bansalimmigration.com.au/public/img/blog/'.$list->image.'?autoplay=1&mute=1';
                                ?>
                                <iframe width="200" height="90" src="<?php echo $src;?>"></iframe>
                            <?php
                            } else if(strtolower($extension) == 'pdf') {
                                $pdfUrl = 'https://bansalimmigration.com.au/public/img/blog/'.$list->image;
                                ?>
                                ...
                                <a href="<?php echo URL::to('/'); ?>/{{@$list->slug}}"><img src="https://bansalimmigration.com.au/public/img/blog/{{@$list->image}}" style="width:318px !important;height:198px !important;"></img></a>
                            <?php
                            }
                        } ?>

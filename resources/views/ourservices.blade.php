...
<section class="custom_breadcrumb bg-img bg-overlay" style="background-image: url('{{ asset('images/bg_2.webp') }}'); padding-top:40px">
	<div class="container">
		<div class="row">
			<div class="col-12">
			...
			<div class="service_row"> 
				...
				<div class="service_col" style="margin-top:5px;border: 1px solid #FFFFFF;">
					<div class="service_item">  
						...
						<a <?php echo $addCls;?> class="readmore" href="<?php echo URL::to('/'); ?>/ourservices/{{@$list->slug}}">Read This More</a>
					</div>
				</div>
				@endforeach
			</div>

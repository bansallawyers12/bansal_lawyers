				...
				<div class="about-content mb-50">
					<div>
						<p style="line-height:16px; color:black">
							<img id="ContentPlaceHolder2_Image1" align="left" src="@smartasset('img/Frontend/73202063430employer.jpg')" style="border-radius:20px; margin-right:20px; margin-bottom:20px; width:400px" />

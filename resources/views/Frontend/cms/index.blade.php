...
@section('content')
	...
	<section class="hero-wrap hero-wrap-2" style="background-image: url('<?php echo $bg_image;?>');margin-bottom: 40px;max-height:422px !important;" data-parallax-bg="0.5">
            ...
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 pb-5 text-center" data-aos="fade-up">
                    ...
                    <p class="breadcrumbs">
                        ...
                        <span>{{@$pagedata->title}} <i data-lucide="arrow-right"></i></span>
                    </p>
                </div>
            </div>
        </div>

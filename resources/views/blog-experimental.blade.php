...
@if(isset($currentPage) && $currentPage > 1)
    ...
    <link rel="canonical" href="<?php echo URL::to('/'); ?>/blog-experimental?page={{ $currentPage }}" />
@else
    ...
    <link rel="canonical" href="<?php echo URL::to('/'); ?>/blog-experimental" />
@endif

<!-- Facebook Meta Tags -->
<meta property="og:url" content="<?php echo URL::to('/'); ?>/blog-experimental{{ isset($currentPage) && $currentPage > 1 ? '?page=' . $currentPage : '' }}">
...
<meta property="twitter:url" content="<?php echo URL::to('/'); ?>/blog-experimental{{ isset($currentPage) && $currentPage > 1 ? '?page=' . $currentPage : '' }}">
            ...
            <div class="col-md-12">
                <div class="experimental-category-filter">
                    ...
                    <div class="experimental-category-buttons">
                        <a href="{{ route('blog.experimental') }}" class="experimental-category-btn {{ !request('category') && !isset($category) ? 'active' : '' }}">All Categories</a>
                    ...
                    <div class="experimental-blog-card">
                        ...
                        <div class="experimental-blog-content">
                            @if(isset($list->categorydetail) && $list->categorydetail)
                                <a href="{{ route('blog.experimental.category', $list->categorydetail->slug) }}" 
            ...
            @empty
                <div class="col-md-12 text-center">
                    <div class="experimental-blog-card" style="padding: 60px 30px;">
                        ...
                        <a href="{{ route('blog.experimental') }}" class="experimental-read-more">

					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								<a href="<?php echo e(route('admin.admin_users.index')); ?>" class="btn btn-secondary">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="first_name" type="text" class="form-control <?php $__errorArgs = ['first_name'];
...
unset($__errorArgs, $__bag); ?>" 
                                                   value="<?php echo e(old('first_name', $admin->first_name)); ?>" data-valid="required" placeholder="Enter first name">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="last_name" type="text" class="form-control <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                   value="<?php echo e(old('last_name', $admin->last_name)); ?>" placeholder="Enter last name">
...
unset($__errorArgs, $__bag); ?>" 
                                                   value="<?php echo e(old('email', $admin->email)); ?>" data-valid="required email" placeholder="Enter email address">
...
unset($__errorArgs, $__bag); ?>" 
                                                   value="<?php echo e(old('phone', $admin->phone)); ?>" placeholder="Enter phone number">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="company_name" type="text" class="form-control <?php $__errorArgs = ['company_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                   value="<?php echo e(old('company_name', $admin->company_name)); ?>" placeholder="Enter company name">
...
unset($__errorArgs, $__bag); ?>" data-valid="required">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group text-right">
                                    <a href="<?php echo e(route('admin.admin_users.index')); ?>" class="btn btn-secondary mr-2">

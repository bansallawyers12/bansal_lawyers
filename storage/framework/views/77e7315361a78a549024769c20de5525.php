                                        ...
                                        <?php $__currentLoopData = @$relatedpagedata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <article class="elementor-post elementor-grid-item post-13164 post type-post status-publish format-standard has-post-thumbnail hentry category-school-abuse tag-nsw">
                                                <div class="elementor-post__card">
                                                    <a class="elementor-post__thumbnail__link" href="<?php echo URL::to('/'); ?>/<?php echo e(@$list->slug); ?>" tabindex="-1">
                                                        <div class="elementor-post__thumbnail">
                                                            <img decoding="async" width="150" height="150" src="<?php echo e(asset('images/' . @$list->image)); ?>" alt="<?php echo e(@$list->image_alt); ?>">
                                                        </div>
                                                    </a>
                                                    <div class="elementor-post__text">
                                                        <h3 class="elementor-post__title">
                                                            <a href="<?php echo URL::to('/'); ?>/<?php echo e(@$list->slug); ?>"><?php echo e(@$list->title); ?></a>
                                                        </h3>
                                                        <a class="elementor-post__read-more" href="<?php echo URL::to('/'); ?>/<?php echo e(@$list->slug); ?>" aria-label="Read more about <?php echo e(@$list->title); ?>" tabindex="-1"> Read This More » </a>
                                                    </div>
                                                </div>
                                            </article>
                                    ...
                                    <div class="elementor-posts-container elementor-posts elementor-posts--skin-cards elementor-grid elementor-has-item-ratio">
                                        <div class="row d-md-flex justify-content-end contactus_div">
                                            ...
                                            <div style="height: 94px;padding-top: 10px;font-weight: 400;">
                                                <img src="<?php echo e(asset('images/bansal_2.jpg')); ?>" width="70" height="80" alt="Ajay Bansal - CEO of Bansal Lawyers">
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansal_lawyers\resources\views/practice_area.blade.php ENDPATH**/ ?>
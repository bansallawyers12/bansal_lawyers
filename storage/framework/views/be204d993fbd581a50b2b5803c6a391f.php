						...
						<div class="modern-card">
							<div class="modern-card-header">
								...
								<div class="modern-header-actions">
									<a href="<?php echo e(route('admin.blog.create')); ?>" class="modern-btn modern-btn-primary">
										<i class="fas fa-plus"></i>
										Create New Post
									</a>
									<form action="<?php echo e(route('admin.blog.index')); ?>" method="get" class="modern-search-form">
										<input type="text" name="search_term" class="modern-search-input" value="<?php echo e(request('search_term')); ?>" placeholder="Search posts...">
											...
											<tr id="id_<?php echo e($list->id); ?>">
												<td>
													...
													<?php if($hasImage): ?>
														...
														<?php else: ?>
															<img src="<?php echo e(asset('images/blog/' . $list->image)); ?>" alt="<?php echo e($list->title); ?>" class="modern-blog-image">
														<?php endif; ?>
													<?php else: ?>
												...
												<td>
													<code class="modern-blog-slug"><?php echo e($list->slug); ?></code>
												</td>
												<td>
													<?php if($list->categorydetail): ?>
												...
												<td>
													<label class="modern-status-toggle">
														<input data-id="<?php echo e($list->id); ?>" data-status="<?php echo e($list->status); ?>" data-col="status" data-table="blogs" class="change-status" value="1" type="checkbox" name="status" <?php echo e(($list->status == 1 ? 'checked' : '')); ?> data-bootstrap-switch>
														<span class="modern-status-slider"></span>
													</label>
												</td>
												<td>
													<div class="modern-actions">
														<a class="modern-btn modern-btn-success modern-btn-sm" href="<?php echo e(URL::to('/admin/blog/edit/'.base64_encode(convert_uuencode($list->id)))); ?>">
															<i class="fas fa-edit"></i>
															Edit
														</a>
														<a class="modern-btn modern-btn-danger modern-btn-sm" href="javascript:;" onClick="deleteAction(<?php echo e($list->id); ?>, 'blogs')">
...
function modernDeleteBlog(id, table) {
    ...
    if (confirm('⚠️ Are you sure you want to delete this blog post?\n\nThis action cannot be undone and will permanently remove:\n• The blog post content\n• Associated images and files\n• All related data\n\nClick OK to confirm deletion.')) {
        ...
        $.ajax({
            ...
            url: '<?php echo e(route("admin.delete_action")); ?>',
            dataType: 'json',
            data: {
                'id': id,
                'table': table

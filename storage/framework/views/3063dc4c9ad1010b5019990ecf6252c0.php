					...
					<div class="card card-primary">
                      ...
                      <div class="card-body">
                          <div class="form-group" style="text-align:right;">
                              <a style="margin-right:5px;" href="<?php echo e(route('admin.cms_pages.index')); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  <input name="title" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Name" value="<?php echo e(old('title')); ?>">
                          ...
                          <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="slug" type="text" class="form-control" data-valid="required" autocomplete="off" placeholder="Enter Slug" value="<?php echo e(old('slug')); ?>">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <textarea class="form-control"  id="description" placeholder="Please Add Description Here" rows="5" name="description"><?php echo old('description'); ?></textarea>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  <textarea name="meta_description" data-valid="" value="" class="form-control" placeholder="Please Add Description Here"><?php echo e(old('meta_description')); ?></textarea>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  <input name="meta_keyward" type="text" value="<?php echo e(old('meta_keyward')); ?>" class="form-control" data-valid="" autocomplete="off" placeholder="Enter Meta Keyward">
                                  <?php if($errors->has('meta_keyward')): ?>
                                      <span class="custom-error" role="alert">
                                          <strong><?php echo e($errors->first('meta_keyward')); ?></strong>
                                      </span>
                                  <?php endif; ?>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                           ...
                           <div class="form-group row">
								...
								<div class="col-sm-10">
									<input value="1" type="checkbox" name="status" data-bootstrap-switch <?php echo e(old('status') ? 'checked' : ''); ?>>
								</div>
							</div>

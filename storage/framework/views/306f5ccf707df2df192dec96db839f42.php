...
<?php $__env->startSection('title', 'Show Appointment'); ?>
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
							<div class="card-header">
								...
								<div class="card-header-action">
									<a href="<?php echo e(route('appointments.index')); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
								</div>
							</div>
					</div>
						<div id="accordion">
                                    ...
                                    <div class="row">
										...
										<div class="col-12 col-md-6 col-lg-6">
											<div class="form-group">
												...
												<div class="cus_field_input">
													<?php echo e(Form::text('date', date('d/m/Y', strtotime($appointment->date)) , array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','readonly' ))); ?>
											...
											<div class="form-group">
                                                ...
                                                <?php if($errors->has('appointment_details')): ?>
                                                    <span class="custom-error" role="alert">
                                                        <strong><?php echo e($errors->first('appointment_details')); ?></strong>
                                                    </span>
                                                <?php endif; ?>
                                            </div>
                                        </div>

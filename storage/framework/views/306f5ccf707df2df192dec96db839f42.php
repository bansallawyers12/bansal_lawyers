						...
						<div class="modern-card modern-main-card">
							<div class="modern-card-header">
								...
								<div class="modern-header-actions">
									...
									<a href="<?php echo e(route('appointments.edit', $appointment->id)); ?>" class="modern-btn modern-btn-primary">
											...
											<div class="modern-card-body">
												<div class="modern-info-grid">
													...
													<div class="modern-info-item">
														...
														<div class="modern-info-value">
															<span class="modern-appointment-id">#<?php echo e($appointment->id); ?></span>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="modern-card-body">
												...
												<div class="modern-datetime-display">
													...
													<div class="modern-datetime-info">
														<h4><?php echo e(date('l, F j, Y', strtotime($appointment->date))); ?></h4>
														<p><?php echo e($appointment->time); ?> - <?php echo e(date('g:i A', strtotime($appointment->time))); ?></p>
													</div>
												</div>
												...
												<div class="modern-info-grid" style="margin-top: 2rem;">
													<div class="modern-info-item">
														...
														<div class="modern-info-value">
															<?php if($appointment->natureOfEnquiry): ?>
																<?php echo e($appointment->natureOfEnquiry->title); ?>
													...
													<div class="modern-info-item">
														...
														<div class="modern-info-value">
															<?php if($appointment->service): ?>
																<?php echo e($appointment->service->title); ?>
													...
													<div class="modern-info-item" style="grid-column: 1 / -1;">
														...
														<div class="modern-info-value">
															<?php echo e($appointment->appointment_details ?? 'Not specified'); ?>
										...
										<div class="modern-card">
											...
											<div class="modern-card-body">
												...
												<div class="modern-info-item">
													...
													<div class="modern-info-value">
														<?php echo e($appointment->created_at->format('d/m/Y H:i:s')); ?><br>
												...
												<div class="modern-info-item">
													...
													<div class="modern-info-value">
														<?php echo e($appointment->updated_at->format('d/m/Y H:i:s')); ?><br>
														<small class="text-muted"><?php echo e($appointment->updated_at->diffForHumans()); ?></small>
													</div>
												</div>
												<?php endif; ?>
											</div>
										...
										<div class="modern-card">
											...
											<div class="modern-card-body">
												<div class="d-grid gap-3">
													<a href="<?php echo e(route('appointments.edit', $appointment->id)); ?>" class="modern-btn modern-btn-primary" style="width: 100%; justify-content: center;">
														<i class="fas fa-edit"></i>
														Edit Appointment
													</a>
													
													<?php if($appointment->clients && $appointment->clients->email): ?>
													<a href="mailto:<?php echo e($appointment->clients->email); ?>?subject=Regarding your appointment on <?php echo e(date('d/m/Y', strtotime($appointment->date))); ?>" 
													...
													<form action="<?php echo e(route('appointments.destroy', $appointment->id)); ?>" method="POST" style="width: 100%;">
														<?php echo csrf_field(); ?>
										...
										<div class="modern-card">
											...
											<div class="modern-card-body">
												...
												<div class="modern-summary-item">
													...
													<span class="modern-summary-value"><?php echo e(strlen($appointment->description)); ?> characters</span>
												</div>
												<div class="modern-summary-item">
													<span class="modern-summary-label">Word Count</span>
													<span class="modern-summary-value"><?php echo e(str_word_count($appointment->description)); ?> words</span>
												</div>
											</div>
										</div>
									</div>
...
function copyAppointmentDetails() {
    ...
    appointmentDetails += 'Client: <?php echo e($appointment->clients->first_name); ?> <?php echo e($appointment->clients->last_name); ?>\n';
    appointmentDetails += 'Client ID: <?php echo e($appointment->clients->client_id); ?>\n';
    appointmentDetails += 'Date: <?php echo e(date('d/m/Y', strtotime($appointment->date))); ?>\n';
    appointmentDetails += 'Time: <?php echo e($appointment->time); ?>\n';
    <?php if($appointment->natureOfEnquiry): ?>
    appointmentDetails += 'Nature of Enquiry: <?php echo e($appointment->natureOfEnquiry->title); ?>\n';
    <?php endif; ?>
    <?php if($appointment->service): ?>
    appointmentDetails += 'Service: <?php echo e($appointment->service->title); ?>\n';
    <?php endif; ?>
    appointmentDetails += 'Appointment Type: <?php echo e($appointment->appointment_details ?? 'Not specified'); ?>\n';
    ...
    appointmentDetails += '\n';
    appointmentDetails += '\nDescription:\n';
    appointmentDetails += '<?php echo e($appointment->description); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansal_lawyers\resources\views/Admin/appointments/show.blade.php ENDPATH**/ ?>
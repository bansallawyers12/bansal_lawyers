				...
				<div class="row justify-content-center">
					<div class="col-12 col-lg-10 col-xl-8">
						<div class="modern-form-card">
							...
							<form action="admin/blogcategories/edit" autocomplete="off" method="post" id="edit-category-form">
								<?php echo csrf_field(); ?>
								...
								<div class="modern-form-body">
									<div class="modern-info-badge">
										...
										Editing Category ID: #<?php echo e($fetchedData->id); ?>
									...
									<div class="modern-form-group">
										...
										<input name="name" type="text" class="modern-form-input" data-valid="required" autocomplete="off" placeholder="Enter category name" value="<?php echo e(old('name', $fetchedData->name)); ?>">
										...
										<div class="modern-help-text">
											Update the descriptive name for your blog category
										</div>
									</div>
									...
									<div class="modern-form-group">
										...
										<select class="modern-select" name="parent_id">
											...
											<?php if($categories): ?>
												<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<?php if($category->id != $fetchedData->id): ?>
														<option value="<?php echo e($category->id); ?>" <?php echo e(old('parent_id', $fetchedData->parent_id) == $category->id ? 'selected' : ''); ?>>
										...
										<div class="modern-help-text">
											Leave empty for a root category, or select a parent to make this a subcategory
										</div>
									</div>
								...
								<div class="modern-form-footer">
									...
									<button type="button" class="modern-btn modern-btn-primary" onClick="customValidate('edit-blogcategory')">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansal_lawyers\resources\views/Admin/blogcategory/edit.blade.php ENDPATH**/ ?>
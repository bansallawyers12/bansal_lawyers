...
<section class="hero-wrap hero-wrap-2" style="background-image: url('<?php echo e(asset('images/Blog.jpg')); ?>');max-height:422px !important;" data-stellar-background-ratio="0.5">
...
<section class="ftco-section bg-light">
            ...
            <div class="col-md-12">
                <div class="category-filter">
                    ...
                    <div class="category-buttons">
                        <a href="<?php echo e(route('blog.index')); ?>" class="btn btn-outline-primary <?php echo e(!request('category') && !isset($category) ? 'active' : ''); ?>">All Categories</a>
                        <?php $__currentLoopData = $blogCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('blog.category', $cat->slug)); ?>" 
                               class="btn btn-outline-primary <?php echo e((isset($category) && $category->id == $cat->id) ? 'active' : ''); ?>">
                                <?php echo e($cat->name); ?>
   ...
   <span style="position:absolute;width:1px;height:1px;padding:0;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0;">
       Read more about <?php echo e(@$list->title); ?>

   </span>
</a>
                        <div class="text px-4 py-4" style="margin-bottom: -40px;">
                            <h3 class="heading mb-0"><a href="<?php echo URL::to('/'); ?>/<?php echo e(@$list->slug); ?>" onclick="showFullBlog(1)"><?php echo e(@$list->title); ?></a></h3>
                        ...
                        <div class="text p-4 float-right d-block">
                            ...
                            <p style="text-align: justify;"><?php echo e(@$list->description == "" ? config('constants.empty') : \Illuminate\Support\Str::limit(strip_tags(@$list->description), 500, '...')); ?> </p>
                            <p><a href="<?php echo URL::to('/'); ?>/<?php echo e(@$list->slug); ?>" class="btn btn-primary" >Read This More</a></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansal_lawyers\resources\views/bloglatest.blade.php ENDPATH**/ ?>
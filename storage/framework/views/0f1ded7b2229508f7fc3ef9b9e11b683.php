...
<div class="navigation-container">
    ...
    <div class="navigation-grid">
        ...
        <div class="nav-card">
            ...
            <div class="nav-links">
                <a href="<?php echo e(route('admin.admin_users.index')); ?>" class="nav-link">
                    <i class="nav-link-icon fas fa-list"></i>
                    <span>All Admin Users</span>
                </a>
                <a href="<?php echo e(route('admin.admin_users.create')); ?>" class="nav-link">
                    <i class="nav-link-icon fas fa-user-plus"></i>
                    <span>Add New Admin</span>
                </a>
						</div>
            
            <a href="<?php echo e(route('admin.admin_users.index')); ?>" class="primary-action">
                <i class="fas fa-arrow-right"></i>
                Manage Users
            </a>
					</div>

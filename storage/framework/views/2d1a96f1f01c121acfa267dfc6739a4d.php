                        ...
                        <div class="card-header">
                            <div class="col-md-6">
                                <div class="card-title">
                                    <a href="<?php echo e(route('admin.recent_case.create')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> New Case</a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card-tools card_tools">
                                    <form action="<?php echo e(route('admin.recent_case.index')); ?>" method="get">
                                            ...
                                            <table id="hoteltable" class="table table-bordered table-hover text-nowrap">
                                                ...
                                                <tbody class="tdata">
                                                    ...
                                                    <tr id="id_<?php echo e($list->id); ?>">
                                                        ...
                                                        <td style="white-space: initial;"><input data-id="<?php echo e($list->id); ?>"  data-status="<?php echo e(!empty($list->status) ? $list->status : 0); ?>" data-col="status" data-table="recent_cases" class="change-status" value="1" type="checkbox" name="status" <?php echo e(($list->status == 1 ? 'checked' : '')); ?> data-bootstrap-switch></td>
                                                        <td>
                                                            <a class="btn btn-info" href="<?php echo e(URL::to('/admin/recent_case/edit/'.base64_encode(convert_uuencode($list->id)))); ?>"> Edit</a>
                                                            <a class="btn btn-danger" href="javascript:;" onClick="deleteAction(<?php echo e($list->id); ?>, 'recent_cases')"> Delete</a>
                                                        </td>
								                    </tr>

...
<div class="modern-sidebar">
    <div class="sidebar-brand">
        <a href="<?php echo e(route('admin.dashboard')); ?>">
            <img alt="Bansal Lawyers" src="<?php echo e(asset('images/logo/Bansal_Lawyers.png')); ?>" />
        </a>
    </div>
    ...
    <ul class="sidebar-menu">
        <div class="menu-section">
            ...
            <li class="menu-item">
                <a href="<?php echo e(route('admin.dashboard')); ?>" 
                   class="menu-link <?php echo e(Route::currentRouteName() == 'admin.dashboard' ? 'active' : ''); ?>">
            ...
            <li class="menu-item">
                <a href="#" 
                   class="menu-link <?php echo e(in_array(Route::currentRouteName(), ['appointments.index', 'appointments-others', 'admin.feature.appointmentdisabledate.index']) ? 'active' : ''); ?>"
                   onclick="toggleSubmenu('appointments')">
                    <i class="menu-icon fas fa-calendar-alt"></i>
                    <span>Appointments</span>
                    <i class="fas fa-chevron-down ml-auto" id="appointments-chevron"></i>
                </a>
                <ul class="submenu" id="appointments-submenu" style="display: <?php echo e(in_array(Route::currentRouteName(), ['appointments.index', 'appointments-others', 'admin.feature.appointmentdisabledate.index']) ? 'block' : 'none'); ?>">
                    <li class="submenu-item">
                        <a href="<?php echo e(route('appointments.index')); ?>" 
                           class="submenu-link <?php echo e(Route::currentRouteName() == 'appointments.index' ? 'active' : ''); ?>">
                            Appointment Listings
                        </a>
                    </li>
                    <li class="submenu-item">
                        <a href="<?php echo e(URL::to('/admin/appointments-others')); ?>" 
                           class="submenu-link <?php echo e(Route::currentRouteName() == 'appointments-others' ? 'active' : ''); ?>">
                            Ajay Calendar
                        </a>
                    </li>
                    <li class="submenu-item">
                        <a href="<?php echo e(route('admin.feature.appointmentdisabledate.index')); ?>" 
                           class="submenu-link <?php echo e(Route::currentRouteName() == 'admin.feature.appointmentdisabledate.index' ? 'active' : ''); ?>">
                            Block Time Slots
                        </a>
                        <a href="<?php echo e(route('admin.feature.bookingblocks.index')); ?>" 
                           class="submenu-link <?php echo e(request()->routeIs('admin.feature.bookingblocks.*') ? 'active' : ''); ?>">
            ...
            <li class="menu-item">
                <a href="<?php echo e(route('admin.cms_pages.index')); ?>" 
                   class="menu-link <?php echo e(in_array(Route::currentRouteName(), ['admin.cms_pages.index', 'admin.cms_pages.create', 'admin.cms_pages.edit']) ? 'active' : ''); ?>">
            ...
            <li class="menu-item">
                <a href="<?php echo e(route('admin.recent_case.index')); ?>" 
                   class="menu-link <?php echo e(in_array(Route::currentRouteName(), ['admin.recent_case.index', 'admin.recent_case.create', 'admin.recent_case.edit']) ? 'active' : ''); ?>">
            ...
            <li class="menu-item">
                <a href="<?php echo e(route('admin.contacts.index')); ?>" 
                   class="menu-link <?php echo e(in_array(Route::currentRouteName(), ['admin.contacts.index', 'admin.contacts.show']) ? 'active' : ''); ?>">

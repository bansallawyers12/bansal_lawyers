						...
						<div class="modern-form-card">
							<div class="modern-form-header">
								...
								<div class="modern-form-actions">
									<a href="<?php echo e(route('admin.blog.index')); ?>" class="modern-btn modern-btn-secondary">
							...
							<form action="<?php echo e(route('admin.blog.edit')); ?>" autocomplete="off" method="post" enctype="multipart/form-data" id="edit-blog-form" name="edit-blog">
								<?php echo csrf_field(); ?>
								...
								<div class="modern-form-body">
									<div class="modern-info-badge">
										...
										Editing Blog Post ID: #<?php echo e($fetchedData->id); ?>
									...
									<div class="modern-form-grid">
										<div class="modern-form-group">
											...
											<input name="title" type="text" class="modern-form-input" data-valid="required" autocomplete="off" placeholder="Enter blog post title" value="<?php echo e(old('title', $fetchedData->title)); ?>">
										...
										<div class="modern-form-group">
											...
											<select class="modern-select" name="parent_category" data-valid="required">
												...
												<?php if($categories): ?>
													<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option value="<?php echo e($category->id); ?>" <?php echo e(old('parent_category', $fetchedData->parent_category) == $category->id ? 'selected' : ''); ?>>
															<?php echo e($category->name); ?>

														</option>
														<?php if(count($category->subcategory)): ?>
															<?php echo $__env->make('Admin.blogcategory.subCategoryList-option',['subcategories' => $category->subcategory], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
														<?php endif; ?>
											...
											<?php if($errors->has('parent_category')): ?>
												<span class="modern-error">
													<?php echo e($errors->first('parent_category')); ?>
										...
										<div class="modern-form-group">
											...
											<div class="modern-checkbox-container">
												<label class="modern-checkbox">
													<input value="1" type="checkbox" name="status" <?php echo e(old('status', $fetchedData->status) == 1 ? 'checked' : ''); ?> data-bootstrap-switch>
									...
									<div class="modern-form-group full-width">
										...
										<input name="short_description" type="text" class="modern-form-input" autocomplete="off" placeholder="Enter a brief description or excerpt" value="<?php echo e(old('short_description', $fetchedData->short_description)); ?>">
									...
									<div class="modern-form-group full-width">
										...
										<div class="modern-editor-container">
											<textarea class="modern-textarea" id="description" placeholder="Write your blog post content here..." rows="10" name="description" data-valid="required"><?php echo e(old('description', $fetchedData->description)); ?></textarea>
										</div>
									...
									<div class="modern-form-grid">
										<div class="modern-form-group">
											...
											<?php if(isset($fetchedData->image) && $fetchedData->image != ""): ?>
												<div class="modern-media-preview">
													...
													<?php elseif(strtolower($extension) == 'pdf'): ?>
														<a href="<?php echo e(asset('images/blog/' . $fetchedData->image)); ?>" target="_blank">
															<i class="fas fa-file-pdf"></i>
															View PDF Document
														</a>
													<?php else: ?>
														<img src="<?php echo e(asset('images/blog/' . $fetchedData->image)); ?>" alt="<?php echo e($fetchedData->title); ?>">
													<?php endif; ?>
												</div>
											<?php endif; ?>
										...
										<div class="modern-form-group">
											...
											<?php if($fetchedData->pdf_doc != ''): ?>
												<div class="modern-media-preview">
													...
													<a href="<?php echo e(asset('images/blog/' . $fetchedData->pdf_doc)); ?>" target="_blank">
									...
									<div class="modern-form-grid">
										...
										<div class="modern-form-group">
											...
											<input name="meta_keyword" type="text" class="modern-form-input" autocomplete="off" placeholder="keyword1, keyword2, keyword3" value="<?php echo e(old('meta_keyword', $fetchedData->meta_keyword)); ?>">

                            ...
                            <div class="modern-card-body">
                                ...
                                <div class="modern-person-display">
                                    ...
                                    <div class="modern-person-info">
                                        <h4>Ajay</h4>
                                        <p>Editing booking blocks for this person</p>
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('add_more').addEventListener('click', function() {
        const firstBlock = document.querySelector('.disable_item');
        ...
        document.getElementById('disable_dates_wrapper').appendChild(newBlock);
        idx++;
    ...
    document.addEventListener('change', function(e) {
        if (e.target.classList.contains('full-day')) {
            ...
            const row = e.target.closest('.disable_item');
    ...
    function updateBlockNumbers() {
        const blocks = document.querySelectorAll('.disable_item');
        blocks.forEach((block, index) => {
            const numberElement = block.querySelector('.modern-block-number');
            if (numberElement) {
    ...
    // Initialize block numbers on page load
    updateBlockNumbers();
});
</script>

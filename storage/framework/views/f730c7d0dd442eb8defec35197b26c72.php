...
<style>
    ...
    * {
    ...
    /* Hero Section */
    .hero-section {
        background-image: url('<?php echo e(asset('images/PracticeArea.jpg')); ?>');
...
<section class="practice-areas-section">
    ...
    <div class="practice-grid">
        ...
        <div class="practice-card fade-in">
            <div class="card-icon">
                <img src="<?php echo e(asset('images/family-law.png')); ?>" alt="Compassionate Legal Support for Family Law Cases" loading="lazy">
            </div>
        ...
        <div class="practice-card fade-in">
            <div class="card-icon">
                <img src="<?php echo e(asset('images/immigration-law.png')); ?>" alt="Expert Immigration Lawyers Helping You Settle in Australia" loading="lazy">
            </div>
        ...
        <div class="practice-card fade-in">
            <div class="card-icon">
                <img src="<?php echo e(asset('images/criminal-law.png')); ?>" alt="Expert Criminal Defense Lawyers in Melbourne" loading="lazy">
            </div>
        ...
        <div class="practice-card fade-in">
            <div class="card-icon">
                <img src="<?php echo e(asset('images/commercial-law.png')); ?>" alt="Expert Commercial Lawyers in Melbourne" loading="lazy">
            </div>
        ...
        <div class="practice-card fade-in">
            <div class="card-icon">
                <img src="<?php echo e(asset('images/property-law.png')); ?>" alt="Expert Property Lawyers in Melbourne" loading="lazy">
            </div>

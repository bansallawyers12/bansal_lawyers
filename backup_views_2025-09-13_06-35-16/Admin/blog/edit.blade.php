									...
									<div class="upload_img">
                                        ...
                                        if(isset($fetchedData->image) && $fetchedData->image != ""){
                                            ...
                                            if( strtolower($extension) == 'mp4' ){
                                               //$src = 'https://bansalimmigration.com.au/public/img/blog/'.$fetchedData->image.'?autoplay=1&mute=1';
                                                ?>
                                            ...
                                            <?php
                                                ...
                                                //$pdfUrl = 'https://bansalimmigration.com.au/public/img/blog/'.$fetchedData->image;
                                                ?>
								...
								<div class="col-sm-10">
									...
									<div class="upload_img">
										@if(@$fetchedData->pdf_doc != '')
											...
											<a target="_blank" href="https://bansalimmigration.com.au/public/img/blog/{{@$fetchedData->pdf_doc}}">Click Here To Open PDF/Video</a>
										@endif
									</div>
								</div>
							</div>

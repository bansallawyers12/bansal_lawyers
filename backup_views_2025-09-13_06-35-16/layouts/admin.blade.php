...
$(document).ready(function(){
    ...
    // Check if notification element exists before adding event listener
    var notificationElement = document.getElementById('countbell_notification');
    if (notificationElement && notificationElement.parentNode) {
        notificationElement.parentNode.addEventListener('click', function(event){
    ...
    function load_unseen_messages(view = '')
    {
        ...
        $.ajax({
            ...
            {
                if(data != 0){
                    // Use native browser notification if supported
                    if ('Notification' in window) {
                        if (Notification.permission === 'granted') {
                            ...
                            // Request permission only when actually needed (user-triggered context)
                    ...
                    // Check if audio player exists before trying to play

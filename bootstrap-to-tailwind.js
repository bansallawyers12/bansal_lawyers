 ...
 * This script provides common Bootstrap to Tailwind class mappings
 */
...
const classMappings = {
    ...
    'text-primary': 'text-bansal-blue-500',
    ...
    'btn-outline-primary': 'border border-bansal-blue-500 text-bansal-blue-500 hover:bg-bansal-blue-500 hover:text-white',
    'btn-outline-secondary': 'border border-gray-500 text-gray-500 hover:bg-gray-500 hover:text-white',
    ...
    'valid-feedback': 'text-green-500 text-sm mt-1',
...
export { classMappings, convertBootstrapToTailwind };
...
if (import.meta.url === `file://${process.argv[1]}`) {
    ...
    console.log(`Total mappings: ${Object.keys(classMappings).length}`);
    console.log('\n🎯 Common conversions:');
    console.log('container → container mx-auto px-4');
    console.log('row → flex flex-wrap');
    console.log('col-md-6 → md:w-1/2');
    console.log('btn btn-primary → bg-bansal-blue-500 hover:bg-bansal-blue-600 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-200');
    console.log('card → bg-white rounded-lg shadow-sm border border-gray-200');
    console.log('form-control → w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-bansal-blue-500 focus:border-transparent transition-colors duration-200');
    console.log('\n💡 Usage: Import this module in your migration scripts');
}

        ...
        if ($request->isMethod('post')) {
			...
			if(isset($id) && !empty($id)) {
				...
				if(BookServiceSlotPerPerson::where('id', '=', $id)->exists()) {
                    ...
                    $disableSlotArr = \App\Models\BookServiceDisableSlot::select('id','book_service_slot_per_person_id','disabledates','slots')->where('book_service_slot_per_person_id',$id)->get();

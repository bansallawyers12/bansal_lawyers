...
class RecentCaseController extends Controller {
    /**
	...
	{ //dd(phpinfo());
		return view('Admin.recent_case.create');
	}
	...
	public function store(Request $request)
	{
        if ($request->isMethod('post'))
		{
			...
			{
				return Redirect::to('/admin/recent_case')->with('success', 'Case added Successfully');
			}
		}
	}
	...
	public function edit(Request $request, $id = NULL)
	{
	    if ($request->isMethod('post'))  {
			...
			$obj				= 	RecentCase::find(@$requestData['id']);
			$obj->title			=	@$requestData['title'];
			$obj->description		=	@$requestData['description'];
			$obj->short_description		=	@$requestData['short_description'];
			//$obj->parent_category		=	@$requestData['parent_category'];
			...
			{
				return Redirect::to('/admin/recent_case')->with('success', 'Case'.Config::get('constants.edited'));
			}
		}
		else
		{
			if(isset($id) && !empty($id))
			{
				...
				{
					return Redirect::to('/admin/recent_case')->with('error', 'Case'.Config::get('constants.not_exist'));
				}
			}
			else
			{
				return Redirect::to('/admin/recent_case')->with('error', Config::get('constants.unauthorized'));
			}
		}
	}
